...
## split allelic reads by maternal and paternal.
#awk -f ${juiceDir}/diploid_split.awk diploid_all-chr.txt

## prepare hic file of maternal/cast hic read pairss.
...
## prepare hic file of b6 hic read pairs.
